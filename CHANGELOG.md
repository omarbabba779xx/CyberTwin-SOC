...
- **README rewrite** — synced to current numbers (819 tests, 14 routers, 80 endpoints, 9-job CI), new sections: pkg A/B/C delivery table, `/api/tasks` sequence diagram + status payload spec.
